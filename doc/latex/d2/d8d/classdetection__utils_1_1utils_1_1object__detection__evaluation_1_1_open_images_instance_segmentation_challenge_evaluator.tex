\doxysection{detection\+\_\+utils.\+utils.\+object\+\_\+detection\+\_\+evaluation.\+Open\+Images\+Instance\+Segmentation\+Challenge\+Evaluator Class Reference}
\hypertarget{classdetection__utils_1_1utils_1_1object__detection__evaluation_1_1_open_images_instance_segmentation_challenge_evaluator}{}\label{classdetection__utils_1_1utils_1_1object__detection__evaluation_1_1_open_images_instance_segmentation_challenge_evaluator}\index{detection\_utils.utils.object\_detection\_evaluation.OpenImagesInstanceSegmentationChallengeEvaluator@{detection\_utils.utils.object\_detection\_evaluation.OpenImagesInstanceSegmentationChallengeEvaluator}}


Inheritance diagram for detection\+\_\+utils.\+utils.\+object\+\_\+detection\+\_\+evaluation.\+Open\+Images\+Instance\+Segmentation\+Challenge\+Evaluator\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=550pt]{d6/d1e/classdetection__utils_1_1utils_1_1object__detection__evaluation_1_1_open_images_instance_segment5dcaf99a46c52f137d5d4b348f318def}
\end{center}
\end{figure}


Collaboration diagram for detection\+\_\+utils.\+utils.\+object\+\_\+detection\+\_\+evaluation.\+Open\+Images\+Instance\+Segmentation\+Challenge\+Evaluator\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=550pt]{d6/d9c/classdetection__utils_1_1utils_1_1object__detection__evaluation_1_1_open_images_instance_segment1fd10ecfb18031fdf9a4f21103c6b75d}
\end{center}
\end{figure}
\doxysubsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{classdetection__utils_1_1utils_1_1object__detection__evaluation_1_1_open_images_instance_segmentation_challenge_evaluator_a078f2cd3ca025b81ae0cf845859faf62}{\+\_\+\+\_\+init\+\_\+\+\_\+}} (self, categories, matching\+\_\+iou\+\_\+threshold=0.\+5, evaluate\+\_\+corlocs=False)
...
\begin{DoxyVerb}A class implements Open Images Instance Segmentation Challenge metric.\end{DoxyVerb}
 

Definition at line \mbox{\hyperlink{object__detection__evaluation_8py_source_l00896}{896}} of file \mbox{\hyperlink{object__detection__evaluation_8py_source}{object\+\_\+detection\+\_\+evaluation.\+py}}.



\doxysubsection{Constructor \& Destructor Documentation}
\Hypertarget{classdetection__utils_1_1utils_1_1object__detection__evaluation_1_1_open_images_instance_segmentation_challenge_evaluator_a078f2cd3ca025b81ae0cf845859faf62}\label{classdetection__utils_1_1utils_1_1object__detection__evaluation_1_1_open_images_instance_segmentation_challenge_evaluator_a078f2cd3ca025b81ae0cf845859faf62} 
\index{detection\_utils.utils.object\_detection\_evaluation.OpenImagesInstanceSegmentationChallengeEvaluator@{detection\_utils.utils.object\_detection\_evaluation.OpenImagesInstanceSegmentationChallengeEvaluator}!\_\_init\_\_@{\_\_init\_\_}}
\index{\_\_init\_\_@{\_\_init\_\_}!detection\_utils.utils.object\_detection\_evaluation.OpenImagesInstanceSegmentationChallengeEvaluator@{detection\_utils.utils.object\_detection\_evaluation.OpenImagesInstanceSegmentationChallengeEvaluator}}
\doxysubsubsection{\texorpdfstring{\_\_init\_\_()}{\_\_init\_\_()}}
{\footnotesize\ttfamily detection\+\_\+utils.\+utils.\+object\+\_\+detection\+\_\+evaluation.\+Open\+Images\+Instance\+Segmentation\+Challenge\+Evaluator.\+\_\+\+\_\+init\+\_\+\+\_\+ (\begin{DoxyParamCaption}\item[{}]{self,  }\item[{}]{categories,  }\item[{}]{matching\+\_\+iou\+\_\+threshold = {\ttfamily 0.5},  }\item[{}]{evaluate\+\_\+corlocs = {\ttfamily False} }\end{DoxyParamCaption})}
...
Definition at line \mbox{\hyperlink{object__detection__evaluation_8py_source_l00900}{900}} of file \mbox{\hyperlink{object__detection__evaluation_8py_source}{object\+\_\+detection\+\_\+evaluation.\+py}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00903\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ evaluate\_corlocs=\textcolor{keyword}{False}):}
\DoxyCodeLine{00904\ \ \ \ \ \textcolor{stringliteral}{"{}"{}"{}Constructor.}}
\DoxyCodeLine{00905\ \textcolor{stringliteral}{}}
\DoxyCodeLine{00906\ \textcolor{stringliteral}{\ \ \ \ Args:}}
\DoxyCodeLine{00907\ \textcolor{stringliteral}{\ \ \ \ \ \ categories:\ A\ list\ of\ dicts,\ each\ of\ which\ has\ the\ following\ keys\ -\/}}
\DoxyCodeLine{00908\ \textcolor{stringliteral}{\ \ \ \ \ \ \ \ 'id'}:\ (required)\ an\ integer\ id\ uniquely\ identifying\ this\ category.}
\DoxyCodeLine{00909\ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{'name'}:\ (required)\ string\ representing\ category\ name\ e.g.,\ \textcolor{stringliteral}{'cat'},\ \textcolor{stringliteral}{'dog'}.}
\DoxyCodeLine{00910\ \ \ \ \ \ \ matching\_iou\_threshold:\ IOU\ threshold\ to\ use\ \textcolor{keywordflow}{for}\ matching\ groundtruth}
\DoxyCodeLine{00911\ \ \ \ \ \ \ \ \ boxes\ to\ detection\ boxes.}
\DoxyCodeLine{00912\ \ \ \ \ \ \ evaluate\_corlocs:\ \textcolor{keywordflow}{if}\ \textcolor{keyword}{True},\ additionally\ evaluates\ \textcolor{keywordflow}{and}\ returns\ CorLoc.}
\DoxyCodeLine{00913\ \ \ \ \ \textcolor{stringliteral}{"{}"{}"{}}}
\DoxyCodeLine{00914\ \textcolor{stringliteral}{\ \ \ \ super(OpenImagesInstanceSegmentationChallengeEvaluator,\ self).\_\_init\_\_(}}
\DoxyCodeLine{00915\ \textcolor{stringliteral}{\ \ \ \ \ \ \ \ categories=categories,}}
\DoxyCodeLine{00916\ \textcolor{stringliteral}{\ \ \ \ \ \ \ \ evaluate\_masks=}\textcolor{keyword}{True},}
\DoxyCodeLine{00917\ \ \ \ \ \ \ \ \ matching\_iou\_threshold=matching\_iou\_threshold,}
\DoxyCodeLine{00918\ \ \ \ \ \ \ \ \ evaluate\_corlocs=\textcolor{keyword}{False},}
\DoxyCodeLine{00919\ \ \ \ \ \ \ \ \ group\_of\_weight=0.0)}
\DoxyCodeLine{00920\ }
\DoxyCodeLine{00921\ }
...
\begin{center}
\leavevmode
\includegraphics[width=313pt]{d2/d8d/classdetection__utils_1_1utils_1_1object__detection__evaluation_1_1_open_images_instance_segmentation_challenge_evaluator_a078f2cd3ca025b81ae0cf845859faf62_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=313pt]{d2/d8d/classdetection__utils_1_1utils_1_1object__detection__evaluation_1_1_open_images_instance_segmentation_challenge_evaluator_a078f2cd3ca025b81ae0cf845859faf62_icgraph}
\end{center}
\end{figure}
