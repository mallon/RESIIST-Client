...
<body>
	...
	<div class="jumbotron">
		<div class="container">
					...
					<table class="w-auto table table-sm" border="1">
						...
						<c:forTokens items="${listdec}" delims="," var="dec"
							...
							<tr>
								...
								<td><c:out value="${scorFAHP[stat2.index]}"></c:out></td>
								<td><c:out value="${rangscoresFAHP[stat2.index]}"></c:out>
							</tr>
						</c:forTokens>
					...
					<table class="w-auto table table-sm" border="1">
						...
						<c:forTokens items="${listdec}" delims="," var="dec"
							...
							<tr>
								...
								<td><c:out value="${dec}"></c:out></td>
								<td><c:out value="${scorAHP[stat2.index]}"></c:out></td>
								<td><c:out value="${rangscoresAHP[stat2.index]}"></c:out>
							</tr>
						</c:forTokens>
					...
					<table class="w-auto table table-sm" border="1">
						...
						<c:forTokens items="${listdec}" delims="," var="dec"
							...
							<tr>
								...
								<td><c:out value="${dec}"></c:out></td>
								<td><c:out value="${scorFANP[stat2.index]}"></c:out></td>
								<td><c:out value="${rangscoresFANP[stat2.index]}"></c:out>
							</tr>
						</c:forTokens>
					...
					<table class="w-auto table table-sm" border="1">
						...
						<c:forTokens items="${listdec}" delims="," var="dec"
							...
							<tr>
								...
								<td><c:out value="${dec}"></c:out></td>
								<td><c:out value="${scorANP[stat2.index]}"></c:out></td>
								<td><c:out value="${rangscoresANP[stat2.index]}"></c:out>
							</tr>
						</c:forTokens>
			...
			<form action="/telechargement1" method="post">
