...
<body>
	<h2 style="text-align: center;">Méthode ANP</h2>

	<form method="post" action="anpSaveDetails">
		Nombre de critères:
		<div class="col-sm-10">
	...
	<form method="post" action="anpGetTableCrit">
	...
	<form method="post" action="anpgetCrit1">
		<table class="w-auto table table-sm" border="1">
	...
	<c:if test="${nbcrit>=2}">
		...
		<form method="post" action="anpgetCrit2">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listdec}" delims="," var="dec"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbcrit>=3}">
		...
		<form method="post" action="anpgetCrit3">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listdec}" delims="," var="dec"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbcrit>=4}">
		...
		<form method="post" action="anpgetCrit4">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listdec}" delims="," var="dec"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbcrit>=5}">
		...
		<form method="post" action="anpgetCrit5">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listdec}" delims="," var="dec"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbcrit>=6}">
		...
		<form method="post" action="anpgetCrit6">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listdec}" delims="," var="dec"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbcrit>=7}">
		...
		<form method="post" action="anpgetCrit7">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listdec}" delims="," var="dec"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbcrit>=8}">
		...
		<form method="post" action="anpgetCrit8">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listdec}" delims="," var="dec"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbcrit>=9}">
		...
		<form method="post" action="anpgetCrit9">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listdec}" delims="," var="dec"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbcrit>=10}">
		...
		<form method="post" action="anpgetCrit10">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listdec}" delims="," var="dec"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<form method="post" action="anpgetDec1">
		<table class="w-auto table table-sm" border="1">
	...
	<c:if test="${nbdec>=2}">
		...
		<form method="post" action="anpgetDec2">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listcrit}" delims="," var="crit"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbdec>=3}">
		...
		<form method="post" action="anpgetDec3">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listcrit}" delims="," var="crit"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbdec>=4}">
		...
		<form method="post" action="anpgetDec4">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listcrit}" delims="," var="crit"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbdec>=5}">
		...
		<form method="post" action="anpgetDec5">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listcrit}" delims="," var="crit"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbdec>=6}">
		...
		<form method="post" action="anpgetDec6">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listcrit}" delims="," var="crit"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbdec>=7}">
		...
		<form method="post" action="anpgetDec7">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listcrit}" delims="," var="crit"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbdec>=8}">
		...
		<form method="post" action="anpgetDec8">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listcrit}" delims="," var="crit"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbdec>=9}">
		...
		<form method="post" action="anpgetDec9">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listcrit}" delims="," var="crit"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<c:if test="${nbdec>=10}">
		...
		<form method="post" action="anpgetDec10">
			<table class="w-auto table table-sm" border="1">
				<c:forTokens items="${listcrit}" delims="," var="crit"
					varStatus="stat4">
					<c:if test="${stat4.index==0}">
	...
	<form method="post" action="anpgetResult">
