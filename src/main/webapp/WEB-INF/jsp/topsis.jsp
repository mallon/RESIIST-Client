...
<body>
	...
	<h2 style="text-align: center;">Méthode TOPSIS</h2>

	<form action="topsisSaveDetails" method="post">
	...
	<form action="topsisInfo" method="post">
	...
	<h5>Informations sur les critères. Indiquer le poids de chaque
		critères.</h5>
	<form action="topsisPoids" method="post">
		<table class="w-auto table table-sm" border="1">
			<tr>
				<c:forTokens items="${listcrit}" delims="," var="c" varStatus="stat">
					<td><c:out value="${c}" /></td>
	...
	<form action="fichTopsis" method="post">
	...
	<form method="post" action="topsisGetTable">
